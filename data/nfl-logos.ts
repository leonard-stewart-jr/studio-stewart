...
export type Conference = "AFC" | "NFC" | "ALL";

export const DIVISIONS: Record<string, Record<string, Team[]>> = {
    AFC: {
        EAST: [
...
Object.keys(DIVISIONS).forEach(conf => {
    Object.keys(DIVISIONS[conf]).forEach(div => {
        DIVISIONS[conf][div].forEach(team => {
            team.image = `/images/prints/nfl/${team.id}.png`;
        });
    });
});

export const divisionNames = ["EAST", "WEST", "SOUTH", "NORTH"] as const;
...
export const AFC_LOGO: Team = {
    id: "afc-logo",
    image: "/images/prints/nfl/afc.png",
    name: "AFC Conference"
};

export const NFC_LOGO: Team = {
    id: "nfc-logo",
    image: "/images/prints/nfl/nfc.png",
    name: "NFC Conference"
};

export const LITHOPHANE: Team = {
    id: "litho-family",
